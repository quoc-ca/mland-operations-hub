...
| --- | --- |
| Guest | A customer who uses the booking journey without creating a the system account. |
| Member | A customer with a the system account; only this actor can use ready-ring retail in V1. |
